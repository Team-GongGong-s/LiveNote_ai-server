...
HOST=${HOST:-54.180.135.94}
PORT=${PORT:-8003}
BASE_URL="http://${HOST}:${PORT}"

CALLBACK_QA=${CALLBACK_QA:-https://webhook.site/4525a60e-54c4-4d3a-9735-b7917d26d211}
CALLBACK_REC=${CALLBACK_REC:-https://webhook.site/4525a60e-54c4-4d3a-9735-b7917d26d211}
CALLBACK_SUMMARY=${CALLBACK_SUMMARY:-https://webhook.site/4525a60e-54c4-4d3a-9735-b7917d26d211}
